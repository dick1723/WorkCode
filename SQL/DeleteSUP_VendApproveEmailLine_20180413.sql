...
delete  from SUP_VendApproveEmailLine  where SUP_VendApproveEmailLine.EMAIL='Fdeng@superl.com.cn' and DATAAREAID='001'

select *  from SUP_VendApproveEmailLine  where SUP_VendApproveEmailLine.EMAIL='Fdeng@superl.com.cn' and DATAAREAID='001'
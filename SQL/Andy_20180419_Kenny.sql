...
and A.PurchPrice>0
and A.TEC_SALESINVENTTRANSID!=''
and A.dataAreaId in('001','301','321','501','201')
--and (A.ItemId like 'T%' or A.ItemId like 'H%' or A.ItemId like 'z%')--comment by mikez on 20180417 no need

and it.ITEMGROUPID=N'Pkg°ü²Ä'
...
and A.ItemBuyerGroupId='PurLocCN' 
and A.TEC_SALESINVENTTRANSID!=''
--and (A.ItemId like 'F%' or A.ItemId like 'A%' or A.ItemId like 'TN%' or A.ITEMID like 'TM%')
and it.ITEMGROUPID=N'Pkg°ü²Ä'
and A.PurchPrice>0
and A.dataAreaId in('001','301','321','501','201')
